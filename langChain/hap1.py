...
if detected_objects:
    ...
    st.write("YOLO 모델 클래스 이름:", class_names)

    # 감지할 객체와 YOLO 클래스 이름을 비교하여 일치하는 이름을 찾기
    matched_objects = [obj for obj in detected_objects if obj in class_names]
    st.write("매칭된 객체들:", matched_objects)
    ...
    if matched_objects:
        ...
        while cap.isOpened():
            ...
            for pred in predictions:
                ...
                if class_names[cls] in matched_objects:
        ...
        st.write("감지할 객체 이름이 YOLO 모델 클래스와 일치하지 않습니다.")
